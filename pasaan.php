...
<!-- Page Content -->
<div class="container">
<form action="pasaan_verwerk.php" method="post">
    <input type="hidden" name="id" id="id" value="<?php echo $item['id'];?>"/>
    <div class="row mb-4 mt-3">
    <div class="form-outline mb-4">
        <label class="form-label" for="naam">Naam</label>
        <input type="text" name="naam" id="naam" class="form-control" value="<?php echo $item['naam'];?>" required/>
    </div>

    <div class="form-outline mb-4">
        <label class="form-label" for="soort">Soort</label>
        <input type="text" name="soort" id="soort" class="form-control" value="<?php echo $item['soort'];?>" required/>
    </div>

    <div class="form-outline mb-4">
        <label class="form-label" for="geboortedatum">Geboortedatum</label>
        <input type="date" name="geboortedatum" id="geboortedatum" class="form-control" value="<?php echo $item['geboortedatum'];?>" required/>
    </div>

    <div class="form-outline mb-4">
        <label class="form-label" for="geslacht">Geslacht</label>
        <select class="form-select" name="geslacht" id="geslacht" aria-label="Default select example" value="<?php echo $item['geslacht'];?>" required >
    ...
    <div class="form-outline mb-4">
        ...
        <input type="text" name="landvanherkomst" id="landvanherkomst" class="form-control" value="<?php echo $item['landvanherkomst'];?>" required/>
    </div>

    <div class="form-outline mb-4">
        <label class="form-label" for="regio">Regio</label>
        <input type="text" name="regio" id="regio" class="form-control" value="<?php echo $item['regio'];?>" required/>
    </div>

    <button type="submit" name="verzend" class="btn btn-primary btn-block mb-4">Aanpassen</button>
</form>
</div>
<div class="container">
